  ...
  const t = {
    tr: {
      ...
      items: {
        ...
        entriesLabel: "KAYIT",
        activeStatus: "AKTİF / ERİŞİLEBİLİR",
        inactiveStatus: "ÇÖZÜMLENEMEDİ",
        heatmapTitle: "DİNAMİK RİSK ISI HARİTASI (ISO 27005)",
        complianceMatrixTitle: "GLOBAL UYUMLULUK VE RİSK MATRİSİ",
        complianceMatrixSubtitle: "ALFA X-RAY V3 DENETİM MODÜLLERİNİN ULUSLARARASI SİBER GÜVENLİK VE BİLGİ TEKNOLOJİLERİ YÖNETİŞİM STANDARTLARI İLE ÇAPRAZ EŞLEŞTİRMESİ.",
        moduleSectionLabel: "MODÜL / BÖLÜM",
        descriptionScopeLabel: "AÇIKLAMA (SCOPE)",
        matrixNote: "* BU MATRİS ISO 27005:2022 RİSK YÖNETİMİ ODAKLI ÇAPRAZ REFERANS TABLOSUDUR.",
        integrityDisclaimer: "Bu rapor ALFA YAPAY ZEKA Teknolojileri tarafından AI destekli olarak gerçek şartlarda üretilmiştir. Herhangi bir düzenleme veya manipülasyon raporun kurguladığı dijital hash imzasını (Integrity Hash) geçersiz kılar. Raporun tüm sayfaları dijital olarak şifrelenmiştir.",
        ...
        sslStatusTitle: "TLS/SSL & HSTS COMPLIANCE ANALİZİ",
        days: "GÜN",
    ...
    en: {
      ...
      items: {
        ...
        activeStatus: "ACTIVE / REACHABLE",
        inactiveStatus: "UNRESOLVED",
        heatmapTitle: "DYNAMIC RISK HEATMAP (ISO 27005)",
        complianceMatrixTitle: "GLOBAL COMPLIANCE & RISK MATRIX",
        complianceMatrixSubtitle: "CROSS-MAPPING OF ALFA X-RAY V3 AUDIT MODULES WITH INTERNATIONAL CYBERSECURITY AND IT GOVERNANCE STANDARDS.",
        moduleSectionLabel: "MODULE / SECTION",
        descriptionScopeLabel: "DESCRIPTION (SCOPE)",
        matrixNote: "* THIS MATRIX IS A CROSS-REFERENCE TABLE FOCUSED ON ISO 27005:2022 RISK MANAGEMENT.",
        integrityDisclaimer: "This report has been generated by ALFA AI Technologies with AI support under real conditions. Any modification or manipulation invalidates the digital integrity hash signature of the report. All pages are digitally encrypted.",
        ...
        sslStatusTitle: "TLS/SSL & HSTS COMPLIANCE ANALYSIS",
        days: "DAYS",
  ...
  if (isAuditLoading || !auditData) {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#fcfcfc] font-mono">
        ...
        <h2 className="text-2xl font-black text-slate-800 tracking-[0.2em] uppercase">
          {isTr ? 'VERİLER DERLENİYOR' : 'COMPILING DATA'}
        </h2>
        <div className="p-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] mt-4 shadow-sm">
           <p className="text-[9px] font-mono text-slate-500 leading-relaxed text-center uppercase tracking-widest">
              {isTr ? "ALFA X-RAY V3 CORE MOTORU, YUKARIDAKİ ÇERÇEVELERLE DOĞAL OLARAK UYUMLUDUR." : "ALFA X-RAY V3 CORE ENGINE IS NATIVELY COMPLIANT WITH THE ABOVE FRAMEWORKS."}
              <br/>
              <span className="text-primary font-black">
                {isTr ? "OTOMATİK ÇAPRAZ REFERANS AKTİF." : "AUTOMATED CROSS-REFERENCING ACTIVE."}
              </span>
           </p>
        </div>
        <p className="text-slate-400 mt-2 font-bold uppercase tracking-widest text-xs">
          {isTr ? 'PENTEST SONUÇLARI POTANSİYEL 250 SAYFAYA YAYILIYOR...' : 'PENETRATION RESULTS SPREADING ACROSS POTENTIAL 250 PAGES...'}
        </p>
      </div>
    );
  }
    ...
    <div className="bg-gray-200 min-h-screen py-12 print:py-0 font-sans print:bg-white text-black text-left overflow-x-hidden transition-all">
      ...
      <div className="fixed bottom-10 right-10 flex flex-col gap-4 print:hidden z-50 animate-in fade-in slide-in-from-bottom-5">
          ...
          >
            ...
            <span className="uppercase tracking-widest text-xs">{t.printBtn}</span>
          </button>
      </div>
