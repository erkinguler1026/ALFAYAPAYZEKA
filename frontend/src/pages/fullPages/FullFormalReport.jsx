...
const FullFormalReport = () => {
  ...
  const t = {
    tr: {
      ...
      sections: {
        s1: "I BÖLÜM : IP ÇÖZÜMLEME VE AĞ İSTİHBARATI",
        s2: "II BÖLÜM : PORT TARAMA VE SERVİS ANALİZİ",
        s3: "III BÖLÜM : HTTP GÜVENLİK BAŞLIKLARI",
        s4: "IV BÖLÜM : SSL/TLS VE HTTPS ANALİZİ",
        s5: "V BÖLÜM : SUNUCU BİLGİ İFŞASI (SERVER EXPOSURE)",
        s6: "VI BÖLÜM : DNS E-POSTA GÜVENLİĞİ (SPF / DMARC)",
        s7: "VII BÖLÜM : HASSAS DOSYA VE YOL TARAMASI",
        s8: "VIII BÖLÜM : SUBDOMAIN / ALT ALAN ADI KEŞFİ",
        s9: "IX BÖLÜM : SSL LABS GÜVENLİK DERECESİ",
        s10: "X BÖLÜM : WHOIS VE RDAP SAHİPLİK BİLGİSİ",
        s11: "XI BÖLÜM : ÇEREZ (COOKIE) GÜVENLİK ANALİZİ",
        s12: "XII BÖLÜM : CORS POLİTİKASI VE API GÜVENLİĞİ",
        s13: "XIII BÖLÜM : TEKNOLOJİ PARMAK İZİ TESPİTİ",
        s14: "XIV BÖLÜM : GEO-IP KONUM VE ISP ANALİZİ",
        s15: "XV BÖLÜM : IP VE DOMAIN İTİBAR KONTROLÜ",
    ...
    en: {
      ...
      sections: {
        s1: "I SECTION : IP RESOLUTION & NETWORK OSINT",
        s2: "II SECTION : PORT SCAN & SERVICE ANALYSIS",
        s3: "III SECTION : HTTP SECURITY HEADERS",
        s4: "IV SECTION : SSL/TLS & HTTPS STATUS",
        s5: "V SECTION : SERVER INFORMATION EXPOSURE",
        s6: "VI SECTION : DNS EMAIL SECURITY (SPF / DMARC)",
        s7: "VII SECTION : SENSITIVE FILE & PATH PROBE",
        s8: "VIII SECTION : SUBDOMAIN DISCOVERY",
        s9: "IX SECTION : QUALYS SSL LABS GRADE",
        s10: "X SECTION : WHOIS & RDAP OWNERSHIP",
        s11: "XI SECTION : COOKIE SECURITY ANALYSIS",
        s12: "XII SECTION : CORS POLICY & API SECURITY",
        s13: "XIII SECTION : TECHNOLOGY FINGERPRINTING",
        s14: "XIV SECTION : GEO-IP & ISP ANALYSIS",
        s15: "XV SECTION : IP & DOMAIN REPUTATION",
        s16: "XVI SECTION : SITEMAP & WEB ARCHITECTURE"
      },
      footer: {
