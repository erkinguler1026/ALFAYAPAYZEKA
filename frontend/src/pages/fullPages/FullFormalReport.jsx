  ...
  const t = {
    tr: {
      ...
      sections: {
        ...
        s3: "II BÖLÜM : PORT TARAMA VE SERVİS ANALİZİ",
        s5: "III BÖLÜM : HTTP GÜVENLİK BAŞLIKLARI",
        s8: "IV BÖLÜM : HASSAS DOSYA VE YOL TARAMASI",
        n1: "V BÖLÜM : SUBDOMAIN / ALT ALAN ADI KEŞFİ",
        n2: "VI BÖLÜM : SSL LABS GÜVENLİK DERECESİ",
        n3: "VII BÖLÜM : WHOIS VE RDAP SAHİPLİK BİLGİSİ",
        n4: "VIII BÖLÜM : ÇEREZ (COOKIE) GÜVENLİK ANALİZİ",
        n5: "IX BÖLÜM : CORS POLİTİKASI VE API GÜVENLİĞİ",
        n6: "X BÖLÜM : TEKNOLOJİ PARMAK İZİ TESPİTİ",
        n7: "XI BÖLÜM : GEO-IP KONUM VE ISP ANALİZİ",
        n8: "XII BÖLÜM : IP VE DOMAIN İTİBAR KONTROLÜ"
      },
      footer: {
    ...
    en: {
      ...
      sections: {
        ...
        s3: "II SECTION : Port Scan & Service Analysis",
        s5: "III SECTION : HTTP Security Headers",
        s8: "IV SECTION : Sensitive File & Path Brute",
        n1: "V SECTION : Subdomain Discovery",
        n2: "VI SECTION : Qualys SSL Labs Grade",
        n3: "VII SECTION : WHOIS & RDAP Ownership",
        n4: "VIII SECTION : Cookie Security Analysis",
        n5: "IX SECTION : CORS Policy & API Security",
        n6: "X SECTION : Technology Fingerprinting",
        n7: "XI SECTION : Geo-IP & ISP Analysis",
        n8: "XII SECTION : IP & Domain Reputation"
      },
      footer: {
